...
export const TotalSaleChart = () => {
    return (
        <>
            <ReactApexChart options={areaChartTotalSale.options} series={areaChartTotalSale.series} type="area" height={250} />
        </>
    )
}
...
export const ColumnChartSale = () => {
    return (
        <>
            <ReactApexChart options={columnChartSale.options} series={columnChartSale.series} type="bar" height={150} />
        </>
    )
}